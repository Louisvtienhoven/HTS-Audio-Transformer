...
#resume_checkpoint = r"C:\Users\Louis\PycharmProjects\HTS-Audio-Transformer\workspace\results\exp_htsat_esc_50\checkpoint\lightning_logs\version_7\checkpoints\l-epoch=19-acc=0.800.ckpt"
# "/home/Research/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
#resume_checkpoint = r"C:\Users\Louis\Downloads\l-epoch=78-acc=0.875.ckpt"
#resume_checkpoint = r"C:\Users\Louis\PycharmProjects\HTS-Audio-Transformer\workspace\results\exp_htsat_esc_50\checkpoint\lightning_logs\version_22\checkpoints\l-epoch=37-acc=0.826.ckpt"
resume_checkpoint = None  # if you want to resume training, set the checkpoint path here
