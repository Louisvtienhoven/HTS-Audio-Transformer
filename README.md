...
Initial experiments based on Mel-spectrogram preprocessing led to erroneous predictions. To improve detection performance, raw spectrograms were used instead, and a second input channel containing amplitude information was introduced. These design modifications are elaborated upon in Section 5.3, while the corresponding model performance is presented in Section 6.3.
