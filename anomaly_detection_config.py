...
# resume_checkpoint = "workspace/ckpt/l-epoch=72-acc=1.000.ckpt"
# resume_checkpoint = "workspace/ckpt/htsat_audioset_pretrain.ckpt"
# resume_checkpoint = "workspace/ckpt/l-epoch=19-acc=0.889.ckpt"
# resume_checkpoint = "workspace/results/exp_htsat_esc_50/checkpoint/lightning_logs/version_7069551/checkpoints/l-epoch=19-acc=0.923.ckpt"
# "/home/Research/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
# resume_checkpoint = "/home/lvantienhoven/projects/HTS-Audio-Transformer/workspace/results/exp_htsat_esc_50/checkpoint/lightning_logs/version_7086580/checkpoints/l-epoch=19-acc=0.800.ckpt"
resume_checkpoint = None
# resume_checkpoint = "workspace/results/exp_htsat_esc_50/checkpoint/lightning_logs/version_7092330/checkpoints/l-epoch=137-acc=0.892.ckpt"
...
htsat_spec_size = 384  # (was 256) ###CHANGED
htsat_patch_size = 4
htsat_stride = (4, 4)
...
# #resume_checkpoint = "workspace/ckpt/l-epoch=19-acc=0.889.ckpt"
# resume_checkpoint = None
# #resume_checkpoint = "/home/lvantienhoven/projects/HTS-Audio-Transformer/workspace/results/exp_htsat_esc_50/checkpoint/lightning_logs/version_7044503/checkpoints/l-epoch=20-acc=0.739.ckpt"
# # "/home/Research/model_backup/AudioSet/HTSAT_AudioSet_Saved_1.ckpt"
...
# sample_rate = 32000 # 16000 for scv2, 32000 for audioset and esc-50##CHANGED
# clip_samples = sample_rate * 1 # audio_set 10-sec clip, was *10##CHANGED
# window_size = 512#(original 1024)
# hop_size = 160 # 160 for scv2, 320 for audioset and esc-50##CHANGED
# mel_bins = 32
# fmin = 0
# fmax = 125
# shift_max = int(clip_samples * 0.5)
...
# # for htsat hyperparamater
# htsat_window_size = 4 ##changed from 8
# htsat_spec_size =  256 #(was 256) ###CHANGED
# htsat_patch_size = 1
# htsat_stride = (2, 2)
# htsat_num_head = [4,8,16,32]
# htsat_dim = 96
